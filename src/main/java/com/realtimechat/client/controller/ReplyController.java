...
public class ReplyController {
    ...
    public ResponseEntity<String> delete(@PathVariable Integer replyId, @AuthenticationPrincipal SecurityUser principal) {
        String response = replyService.delete(principal.getMember(), replyId);
